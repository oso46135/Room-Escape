...
void opencomputer(){	//잠금 풀린 컴퓨터 
	...
	while(1){
		...
		if(a == 1){
			...
			printf("[중앙]-[컴퓨터]\n");
			Sleep(1500);
			printf("당신은 '그림을A다'을 제외한 다른 파일을 찾습니다.\n");
			Sleep(1500);
			printf(".");
			Sleep(1500);
			printf(".");
...
void bedsp(){		//침대에서 잔다.
	...
	system("cls");
	printf("[중앙]-[침대]\n\n");
	printf("당신은 침대에 살이 닿자마자 졸음이 K아졌습니다.\n");
	printf(".");
	Sleep(1000);
	printf(".");
	Sleep(1000);
...
void ending(){		//엔딩 
	...
	printf("총을 들고 몇 초가 지나고서야 저사람은 우리 적이 아니라는 것을 틈騁努윱求.\n");
